...
//////////////////////////////////////////////////121
#define p_mos			pa.5
#define p_mickey		pa.6
#define p_key			pa.4
#define p_check			pb.7
#define p_check_ad		PB7	
#define p_full			pb.4	
#define p_charge		pb.4	

#define p_led_r_on		{ pb.1 = 0; }
#define p_led_r_off		{ pb.1 = 1; } 
#define p_led_g_on		{ pa.0 = 0; }
#define p_led_g_off		{ pa.0 = 1; } 
#define p_led_b_on		{ pa.3 = 0; }
#define p_led_b_off		{ pa.3 = 1; } 


#define p_mos_c			pac.5
#define p_check_c		pbc.7

#define set_check_ad	{$ pbdier	0b_0001_0000;}
#define set_check_io	{$ pbdier	0b_1001_0000;}
...
/////////////////////////////121
	pa =	0b_0010_1001;				//0:低电平		1:高电平(输出模式下，输出低时自动关上拉)
	pac =	0b_0010_1001;				//0:输入		1:输出
	pa =	0b_0010_1001;				//0:低电平		1:高电平(输出模式下，输出低时自动关上拉)
	paph =	0b_0001_0000;				//0:关上拉		1:开上拉
   $ padier	0b_0101_0000;				//0:模拟端口	1:数字端口
	
	pb =	0b_0000_0010;				//0:低电平		1:高电平(输出模式下，输出低时自动关上拉)
	pbc =	0b_0000_0010;				//0:输入		1:输出
	pb =	0b_0000_0010;				//0:低电平		1:高电平(输出模式下，输出低时自动关上拉)
	pbph =	0b_0001_0000;				//0:关上拉		1:开上拉
  $ pbdier	0b_1001_0000;				//0:模拟端口	1:数字端口
/*
/////////////////////////////363
